...
import uk.ac.york.callcentre.Statement;
...
public class CallcentrePackageImpl extends EPackageImpl implements CallcentrePackage {
	 ...
	 * @see uk.ac.york.callcentre.CallcentrePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CallcentrePackage init() {
		if (isInited)
			return (CallcentrePackage) EPackage.Registry.INSTANCE.getEPackage(CallcentrePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCallcentrePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CallcentrePackageImpl theCallcentrePackage = registeredCallcentrePackage instanceof CallcentrePackageImpl
				? (CallcentrePackageImpl) registeredCallcentrePackage
				: new CallcentrePackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getModel_Steps(), this.getStep(), null, "steps", null, 0, -1, Model.class, !IS_TRANSIENT,
		...
		initEAttribute(getStep_Name(), ecorePackage.getEString(), "name", null, 0, 1, Step.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStep_Text(), ecorePackage.getEString(), "text", null, 0, 1, Step.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStep_Incoming(), this.getTransition(), this.getTransition_To(), "incoming", null, 0, -1,
		...
		initEClass(callRedirectionEClass, CallRedirection.class, "CallRedirection", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCallRedirection_Number(), ecorePackage.getEString(), "number", null, 0, 1,
				CallRedirection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(inputQuestionEClass, InputQuestion.class, "InputQuestion", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInputQuestion_Variable(), ecorePackage.getEString(), "variable", null, 0, 1,
				InputQuestion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
