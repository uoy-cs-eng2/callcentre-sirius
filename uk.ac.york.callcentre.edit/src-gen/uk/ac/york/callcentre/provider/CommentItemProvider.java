...
/**
 * This is the item provider adapter for a {@link uk.ac.york.callcentre.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_author_feature",
								"_UI_Comment_type"),
						CallcentrePackage.Literals.COMMENT__AUTHOR, true, false, false,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CallcentrePackage.Literals.COMMENT__TEXT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case CallcentrePackage.COMMENT__AUTHOR:
		case CallcentrePackage.COMMENT__TEXT:
